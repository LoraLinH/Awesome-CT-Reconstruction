...
- <a name="IntraTomo"></a>**[IntraTomo]** IntraTomo: Self-supervised Learning-based Tomography via Sinogram Synthesis and Prediction (**ICCV**) [[paper](https://openaccess.thecvf.com/content/ICCV2021/papers/Zang_IntraTomo_Self-Supervised_Learning-Based_Tomography_via_Sinogram_Synthesis_and_Prediction_ICCV_2021_paper.pdf)] [[Code](https://github.com/vccimaging/IntraTomo)]
...
- <a name="DGR"></a>**[DGR]** An Unsupervised Reconstruction Method For Low-Dose CT Using Deep Generative Regularization Prior (**Biomedical Signal Processing and Control**) [[paper](https://arxiv.org/pdf/2012.06448.pdf)] [[Code](https://github.com/mozanunal/SparseCT)]
- <a name="HD-CNN"></a>**[HD-CNN]** Artifact removal using a hybrid-domain convolutional neural network for limited-angle computed tomography imaging (**PMB**) [[paper](https://iopscience.iop.org/article/10.1088/1361-6560/ab9066/meta)]
...
- <a name="iCTNet"></a>**[iCTNet]** Sinogram interpolation for sparse-view micro-CT with deep learning neural network (**Medical Imaging**) [[paper](https://arxiv.org/ftp/arxiv/papers/1902/1902.03362.pdf)] [[Code](https://github.com/Swapneel7/Sparse-CT-Reconstruction-using-Deep-learning)]
- <a name="PSRV"></a>**[PSRV]** Patient-specific reconstruction of volumetric computed tomography images from a single projection view via deep learning (**Nature biomedical engineering**) [[paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6858583/)]
